...
<body>
    ...
    <script>
        ...
        function abrirModalEditar(id, nomeLocal, categoria, raridade) { document.getElementById('editAdesivoId').value = id; document.getElementById('editNomeLocal').value = nomeLocal; document.getElementById('editCategoria').value = categoria || 'Urbano'; document.getElementById('editRaridade').value = raridade || 'Comum'; new bootstrap.Modal(document.getElementById('modalEditar')).show(); }
